 ...
 */
@ApiModel(value = "云管理云资源计量规格镜像表", description = "云管理云资源计量规格镜像表")
public class Instance2Specimag extends BaseEntity implements Serializable {
