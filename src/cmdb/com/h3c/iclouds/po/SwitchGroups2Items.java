...
@Api(value = "交换机堆叠")
public class SwitchGroups2Items extends BaseEntity implements java.io.Serializable {
	...
	private SwitchGroups group;
	
	private AsmMaster asmMaster;
	
	public SwitchGroups2Items() {
	...
	public SwitchGroups getGroup() {
		return group;
	}

	public void setGroup(SwitchGroups group) {
		this.group = group;
	}
