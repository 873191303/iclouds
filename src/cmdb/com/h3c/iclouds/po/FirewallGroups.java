...
@ApiModel(value = "资源配置防火墙堆叠信息", description = "资源配置防火墙堆叠信息")
@SuppressWarnings("rawtypes")
public class FirewallGroups extends BaseEntity implements java.io.Serializable {
