...
@ApiModel(value = "资产管理-交换机资产配置信息", description = "资产管理-交换机资产配置信息")
public class Master2Switch extends BaseEntity implements java.io.Serializable {
	...
	public String getNetSlots() {
		return netSlots;
	}

	public void setNetSlots(String netSlots) {
		this.netSlots = netSlots;
	}
