 ...
 */
@ApiModel(value = "云运维存储关系拓扑视图", description = "云运维存储关系拓扑视图")
public class StorageRelation implements Serializable {
    ...
    private List<StorageRelation> children;

    @ApiModelProperty(value = "卷数量")
    ...
    public List<StorageRelation> getChildren() {
        return children;
    }

    public void setChildren(List<StorageRelation> children) {
