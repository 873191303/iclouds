 ...
 */
@ApiModel(value = "vdc视图信息")
public class VdcInfo implements Serializable {
    ...
    @NotNull
    @ApiModelProperty(value = "对象类型(NotNull)", notes = "1-防火墙，2-路由器，3-网络，4-负载均衡")
    ...
    @ApiModelProperty(value = "负载均衡实服务网络uuid")
    private String vlbPoolFactUuid;
    ...
    public String getVlbPoolFactUuid() {
        return vlbPoolFactUuid;
    }

    public void setVlbPoolFactUuid(String vlbPoolFactUuid) {
        this.vlbPoolFactUuid = vlbPoolFactUuid;
    }
